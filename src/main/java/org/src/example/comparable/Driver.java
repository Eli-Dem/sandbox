...
public class Driver {
    public static void main(String[] args) {
        ...
        Apple apple2 = new Apple(Size.MEDIUM, Color.RED, "Fiji");
        ...
        Apple apple6 = new Apple(Size.SMALL, Color.GREEN, "McIntosh");
        Apple apple7 = new Apple(Size.XLARGE, Color.GREEN, "McIntosh");
